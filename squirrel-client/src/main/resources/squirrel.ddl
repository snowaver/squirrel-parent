...
(
	ID  BIGINT  PRIMARY  KEY  NOT  NULL,IS_DELETED  BIT  NOT  NULL  DEFAULT  FALSE,CREATE_TIME  DATETIME  NOT  NULL,LAST_MODIFY_TIME  DATETIME  NOT  NULL,NAME  VARCHAR(255)  NOT  NULL
);

CREATE  TABLE  IF  NOT  EXISTS  chat_group_user
(
	ID  BIGINT  PRIMARY  KEY  NOT  NULL,IS_DELETED  BIT  NOT  NULL  DEFAULT  FALSE,CREATE_TIME  DATETIME  NOT  NULL,LAST_MODIFY_TIME  DATETIME  NOT  NULL,CHAT_GROUP_ID  BIGINT  NOT  NULL,CONTACT_ID  BIGINT  NOT  NULL,VCARD  VARCHAR(255)
);
