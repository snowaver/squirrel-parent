...
(
	ID  BIGINT  PRIMARY  KEY  NOT  NULL,USERNAME  VARCHAR(255),CREATE_TIME  DATETIME,LAST_MODIFY_TIME  DATETIME,SUBSCRIBE_STATUS  INT  NOT  NULL,REMARK  VARCHAR(255),GROUP_NAME  VARCHAR(255)
);
